...
signatures_significance = signaturesSignificance(x=contexts_matrix,beta=signatures_decomposition$beta$"3_signatures",cosine_thr=0.95,min_contribution=0.05,pvalue_thr=0.05,sparsify=FALSE,nboot=1000,num_processes=5,seed=11111,verbose=TRUE)
