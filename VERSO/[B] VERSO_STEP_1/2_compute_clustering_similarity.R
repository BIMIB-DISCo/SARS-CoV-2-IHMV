...
"compute.likelihood.attachament" <- function( D, B, curr_alpha, curr_beta ) {
    ...
    # find assignment at maximum log likelihood
...
load(file="clonal_variants.RData")
load(file="inference.RData")
...
# save results
save(C_extended,file="RData/C_extended.RData")
save(samples_similarity,file="RData/samples_similarity.RData")
