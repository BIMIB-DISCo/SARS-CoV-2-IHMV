...
CLUSTER[which(CLUSTER==1)] = "Cluster SC#1"
CLUSTER[which(CLUSTER==2)] = "Cluster SC#3"
CLUSTER[which(CLUSTER==3)] = "Cluster SC#2"
...
signatures_clustering[which(signatures_clustering[,"Cluster"]==1)] = "Cluster SC#1"
signatures_clustering[which(signatures_clustering[,"Cluster"]==2)] = "Cluster SC#3"
signatures_clustering[which(signatures_clustering[,"Cluster"]==3)] = "Cluster SC#2"
