...
sampleName="ABCDE" # name of the single-end sample to be analyzed.
...
trimmomatic SE -threads $jobs -phred33 -summary ${fastqTrimDir}${sampleName}_trim.summary -quiet ${basedir}${sampleName}.fastq ${fastqTrimDir}${sampleName}.trim.fastq.gz LEADING:20 TRAILING:20 SLIDINGWINDOW:4:20 MINLEN:40
